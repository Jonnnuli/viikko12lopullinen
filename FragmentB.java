...
public class FragmentB extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        buttonImportant = view.findViewById(R.id.buttonImportant);

        buttonImportant.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String important = newPurchase.getText().toString();
                data = important + "  " + data;
                Bundle result = new Bundle();
                result.putString("dataFB", data);
                getParentFragmentManager().setFragmentResult("dataFromB", result);
                //newPurchase.setText("");
